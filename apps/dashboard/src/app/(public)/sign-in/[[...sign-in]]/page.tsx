...
export default function Page() {
  return (
    <div className="flex justify-start items-center bg-white h-full w-full overflow-y-auto">
      <div className=" w-full md:w-[40%] h-full flex gap-16 p-6 items-center flex-col max-h-screen relative justify-between">
        <SignIn
          appearance={{
            layout: {
            ...
            elements: {
              ...
              formFieldRow__name: { flexDirection: 'column' },
              headerTitle: {
                textAlign: 'left',
                fontSize: '2rem',
                marginTop: '6rem',
